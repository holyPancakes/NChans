    ...
    window['ChessBoard3'] = window['ChessBoard3'] || function(containerElOrId, cfg) {
            ...
            */
            ...
            function buildBoard() {
                var i;
                for (i = 0; i < n; i++) {
                    var tz = n/2 * SQUARE_SIZE - (SQUARE_SIZE * (i)) ;
                    for (var j = 0; j < n; j++) {
                        var tx = (SQUARE_SIZE * (j)) - n/2 * SQUARE_SIZE+1;
                        var square = 'abcdefghijklmnopqrstuvwvxyz'.charAt(j) + (i + 1);
            ...
            function squareCoordinates(square) {
                ...
                if (validSpareSquare(square)) {
                    ...
                    tz = n/2 * SQUARE_SIZE - SQUARE_SIZE * (square.charCodeAt(1) - '1'.charCodeAt(0));
                }
                return {
                    x : tx,
                    z : tz
